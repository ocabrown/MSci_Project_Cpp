...
def Plot(Simulation_Data, y_variable, x_variable, data_type=None, Comparison_Data=None, Params=None, calc=False, Movshovitz=False, Evo=False, alpha_comp=False, acc_reg=False):
    
    num_g = 1                       # Number of ghost cells on each side
    R_J = 6.9911e9                  # Jupiter radius [cm]
    Ma_E = 5.972e27                 # Earth mass [g]
    L_J = 5.0e24                    # Jupiter luminosity [erg/s]
    L_S = 3.846e33                  # Solar luminosity [erg/s]
    
    
    if data_type == "IsoT" or data_type == "IsoD":
    
        if data_type == "IsoT":
            m, r, p, T, P, s, p_ana, dP_dr_num, dP_dr_ana = [var[num_g:-(num_g+1)] for var in Simulation_Data]
            Figsize, lw, Ticksize, Labelsize, Legendfontsize = [7, 2, 20, 20, 15]
            dP_dr_division = 1e-6
        elif  data_type == "IsoD":
            m, r, p, T, P, s, T_ana, dP_dr_num, dP_dr_ana = [var[num_g:-(num_g+1)] for var in Simulation_Data]
        ...
        if x_variable == "m":
            ...
            if y_variable == "r":
                ...
                plt.plot(m/Ma_E, s, linewidth=lw)
        ...
        # Plots against r
            ...
            if y_variable == "m":
                plt.loglog(r/R_J, m/Ma_E, linewidth=lw)
            ...
            elif y_variable == "T_comp":
                plt.plot(r/R_J, T, linewidth=lw, color="blue", label="Numerical Solution")
                plt.plot(r/R_J, T_ana, "--", linewidth=lw, color="orange", label="Analytical Solution")
                plt.ylabel("Temperature / K")
                plt.xscale("log")
                #plt.title("Temperature vs. Radius Comparison")
                plt.legend()
            
            elif y_variable == "dP/dr":
                plt.plot(r/R_J, dP_dr_num/dP_dr_division, linewidth=lw, color="blue", label="Numerical Solution")
                plt.plot(r/R_J, dP_dr_ana/dP_dr_division, "--", linewidth=lw, color="orange", label="Analytical Solution")
                plt.ylabel("Pressure Gradient / $\mu$dyne$\cdot$cm$^{-3}$")
                plt.xscale("log")
                #plt.title("Pressure Gradient vs. Radius Comparison")
                plt.legend()
            
            elif y_variable == "dP/dr_lower":
                plt.plot(r[:min_pos]/R_J, dP_dr_num[:min_pos]/dP_dr_division, linewidth=lw, label="Numerical Solution")
                plt.plot(r[:min_pos]/R_J, dP_dr_ana[:min_pos]/dP_dr_division, "--", linewidth=lw, label="Analytical Solution")
                plt.ylabel("Pressure Gradient / ndyne$\cdot$cm$^{-3}$")
                plt.xscale("log")
                #plt.title("Pressure Gradient vs. Radius - Low")
                plt.legend()
            
            elif y_variable == "dP/dr_upper":
                plt.plot(r[min_pos:]/R_J, dP_dr_num[min_pos:]/dP_dr_division, linewidth=lw, label="Numerical Solution")
                plt.plot(r[min_pos:]/R_J, dP_dr_ana[min_pos:]/dP_dr_division, "--", linewidth=lw, label="Analytical Solution")
                plt.ylabel("Pressure Gradient / ndyne$\cdot$cm$^{-3}$")
                plt.xscale("log")
                ...
                l2 = ax2.plot(r/R_J, dP_dr_num/dP_dr_division, color=color1, linewidth=lw, label="Numerical dP/dr Solution")
                l3 = ax2.plot(r/R_J, dP_dr_ana/dP_dr_division, ":", color=color2, linewidth=lw, label="Analytical Solution")
        ...
        if x_variable == "t":
            ...
            if y_variable == "M":
                plt.plot(t/1e6, M/Ma_E, linewidth=lw)
            ...
            if y_variable == "Mdot+M":
                ...
                ax2.plot(t[:]/1e6, M[:]/Ma_E, color=color2, linewidth=lw)
                ax2.tick_params(axis='y')
                fig.tight_layout()
            ...
            if len(Simulation_Data) == 3:
                ...
                if y_variable == "M":
                    plt.plot(t0[:]/1e6, M0[:]/Ma_E, linewidth=lw, color="blue", label="$\kappa$ = $\kappa_0$")
                    plt.plot(t1[:]/1e6, M1[:]/Ma_E, linewidth=lw, color="red", label=r"$\kappa$ = $\kappa_0$/6")
                    plt.plot(t2[:]/1e6, M2[:]/Ma_E, linewidth=lw, color="orange", label=r"$\kappa$ = $\kappa_0$/12")
                    #plt.yscale("log")
                    plt.ylabel("Total Mass / $M_{\oplus}$")
                    #plt.title("Total Mass vs. Time")
                ...
                if y_variable == "m_t comp":
                    ...
                    #plt.plot(r_plot1/R_J, m_plot1/Ma_E, linewidth=lw, linestyle="-", color="blue", label=f"{t[0]/1e6} Myr")
                    plt.plot(r_plot1/R_J, m_found1/Ma_E, linewidth=lw, linestyle="-", color="blue", label=f"{t[0]/1e6} Myr")
                    #plt.axvline(x=r_plot1[-tau_i1]/R_J, linewidth=lw, linestyle="--", color="blue")
                    #plt.plot(r_plot2/R_J, 11*m_plot2/Ma_E, linewidth=lw, linestyle="-", color="red", label=f"{t[middle_time]/1e6} Myr")
                    plt.plot(r_plot2/R_J, m_found2/Ma_E, linewidth=lw, linestyle="-", color="red", label=f"{t[middle_time]/1e6} Myr")
                    #plt.axvline(x=r_plot2[-tau_i2]/R_J, linewidth=lw, linestyle="--", color="red")
                    #plt.plot(r_plot3/R_J, 11*m_plot3/Ma_E, linewidth=lw, linestyle="-", color="orange", label=f"{t[-1]/1e6} Myr")
                    plt.plot(r_plot3/R_J, m_found3/Ma_E, linewidth=lw, linestyle="-", color="orange", label=f"{t[-1]/1e6} Myr")
                    #plt.axvline(x=r_plot3[-tau_i3]/R_J, linewidth=lw, linestyle="--", color="orange")
                    plt.xscale("log")
                ...
                for j in range(len(ks)):
                    ...
                    tau_i = TLF.Tau_Line_Finder(r_plot, p_plot, k_plot, tau)
                    phi_plot = -(G*(m_plot+(10*Ma_E))/r_plot)
            ...
            if x_variable == "m":
                ...
                if y_variable == "r":
                    ...
                    plt.plot(m/Ma_E, k, linewidth=lw)
                    plt.ylabel("Opacity / cm$^{2}$$\cdot$g$^{-1}$")
